...
TOOL_DECLARATIONS = [
    ...
    {"name": "read_file",
     ...
     "input_schema": {"type": "object", "properties": {"path": {"type": "string", "description": "File path (relative)."}}, "required": ["path"]}},
    {"name": "write_file",
...
class CustomAgent(BaseAgent):
    ...
    def _loop(self, prompt, cwd, tc_log, msg_log, resp) -> AgentResult:
        ...
        for it in range(max_iters):
            ...
            tool_uses = [{"id": block.id, "name": block.name, "input": block.input}
